...
export default function ContactForm() {
  ...
  if (sent) {
    return <h2 style={{ maxWidth: 600, width: '100%', margin: 'auto', padding: '0 20px', textAlign: 'center' }}>Thank you! We will get in touch shortly.</h2>;
  }

  return (
    <Form onSubmit={handleSubmit} style={{ maxWidth: 600, width: '100%', margin: 'auto', padding: '0 20px' }}>
      ...
      >
        <TextArea style={{ height: 300, width: '100%', maxWidth: 600 }} />
      </FormField>
